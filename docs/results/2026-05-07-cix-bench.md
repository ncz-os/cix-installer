...
| **bigpi** — Pi 5 Model B 16 GB, ARM CPU only | TBD (4–5 sustained) | TBD | TBD | BGE-Q8 GGUF, n_ctx=8192 | in-flight |
...
| **ULTRA** — Apple M1 Max Metal (laptop) | **57.38** | 5.4 ms | 140.1 | same (laptop, thermal-limited vs Mac Studio active cooling) | done |
