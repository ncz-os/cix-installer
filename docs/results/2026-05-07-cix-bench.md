...
| **Apple laptop, M-series** | jperlow-mlt (this Mac) | MacBook Pro 16" 2023 — Apple M3 Pro | 36 GB | ~$2500 portable workstation |
| **Apple laptop, M1 Max** | ULTRA (.60) | MacBook Pro 16" 2021 — Apple M1 Max | 64 GB | ~$3000 portable build host |
...
|---|---|---|---|---|---|
| **zeropi** — Pi 4 Model B 2 GB, ARM CPU only | TBD | TBD | TBD | BGE-Q8 GGUF, n_ctx=2048 (RAM-tight) | setup queued |
| **bigpi** — Pi 5 Model B 16 GB, ARM CPU only | 5.2 sustained | TBD | TBD | BGE-Q8 GGUF, n_ctx=8192 | in-flight, ~18 min remaining |
| **NCZ Magnetar** — Cix Sky1 12-core ARM CPU | TBD | TBD | TBD | BGE-Q8 GGUF, n_ctx=8192 | in-flight |
| **NCZ Magnetar** — Cix Zhouyi V3 NPU (INT8 .cix) | **54.86** | 14.6 ms | 146 | `bge-small-zh-v1.5_256.cix`, libnoe 2.0.0 | done |
| **PYTHIA** — Intel Core 5 210H CPU | 12 sustained | TBD | TBD | BGE-Q8 GGUF, n_ctx=8192 | in-flight, ~5 min remaining |
| **PYTHIA** — Intel iGPU via OpenVINO | TBD | TBD | TBD | OpenVINO BGE model | queued (peer iGPU bench) |
| **jperlow-mlt** — Apple M3 Pro Metal | **107.07** | 9.7 ms | 75.1 | BGE-Q8 GGUF, Metal n_gpu_layers=99 | done |
| **ULTRA** — Apple M1 Max Metal | TBD | TBD | TBD | same | queued (after nomic finishes) |
| **STUDIO** — Apple M1 Max Metal (Mac Studio desktop) | TBD | TBD | TBD | same | queued (after nomic finishes) |
